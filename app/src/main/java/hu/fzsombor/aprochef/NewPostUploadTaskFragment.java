...
import hu.fzsombor.aprochef.Models.Author;
...
public class NewPostUploadTaskFragment extends Fragment {
    ...
    public void uploadPost(Bitmap bitmap, String inBitmapPath, Bitmap thumbnail, String inThumbnailPath,
                           String inFileName, String inPostName, String inShortDescription, String inLongDescription) {
        UploadPostTask uploadTask = new UploadPostTask(bitmap, inBitmapPath, thumbnail, inThumbnailPath, inFileName, inPostName, inShortDescription, inLongDescription);
        uploadTask.execute();
    }
    ...
    class UploadPostTask extends AsyncTask<Void, Void, Void> {
        ...
        public UploadPostTask(Bitmap bitmap, String inBitmapPath, Bitmap thumbnail, String inThumbnailPath,
                              String inFileName, String inPostName, String inShortDescription, String inLongDescriptions) {
            ...
            longDescription = inLongDescriptions;
                            ...
                            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                                ...
                                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                                    ...
                                    Post newPost = new Post(author, fullSizeUrl.toString(), fullSizeRef.toString(),
                                            thumbnailUrl.toString(), thumbnailRef.toString(), postName, shortDescription, longDescription, ServerValue.TIMESTAMP);
