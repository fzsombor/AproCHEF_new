...
public class NewPostActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText nameText = (EditText) findViewById(R.id.new_post_name);
        final EditText shortDescriptionText = (EditText) findViewById(R.id.new_post_short);
        final EditText longDescriptionText = (EditText) findViewById(R.id.new_post_long);
        ...
        mSubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(final View v) {
                ...
                String postName = nameText.getText().toString();
                if (TextUtils.isEmpty(postName)) {
                    nameText.setError(getString(R.string.error_required_field));
                    return;
                }

                String postShortDescription = shortDescriptionText.getText().toString();
                if (TextUtils.isEmpty(postShortDescription)) {
                    shortDescriptionText.setError(getString(R.string.error_required_field));
                    return;
                }
                String postLongDescription = longDescriptionText.getText().toString();
                if (TextUtils.isEmpty(postShortDescription)) {
                    longDescriptionText.setError(getString(R.string.error_required_field));
                    return;
                }
                ...
                mTaskFragment.uploadPost(mResizedBitmap, bitmapPath, mThumbnail, thumbnailPath, mFileUri.getLastPathSegment(),
                        postName, postShortDescription, postLongDescription);
            }
        });
    }
